...
sampleUI:newUI( { theme="darkgrey", title="Native Display Objects", showBuildNum=false } )
...
local function onButtonRelease( event )
	...
	elseif ( buttonID == "Web View" ) then
		...
		local viewHeight = display.actualContentHeight - ( objectLabel.y - display.screenOriginY + 50 )
...
buttonGroup.y = display.contentHeight - (buttonGroup.contentHeight/2) - display.screenOriginY - 18
